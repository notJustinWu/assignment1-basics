...
from cs336_basics.model_moe import SparseMoE, transformer_block_with_MoE, transformer_lm_with_MoE
...
def train_lm(train_tokens_path: str, 
    ...
    wandb_project: str,
    device: str = "cuda",
    checkpoint_dir: str = "/data/c-justwu/a1/checkpoints/MoE/",
    ...
    # instantiate model
    model = transformer_lm_with_MoE(vocab_size=vocab_size,
...
def main():
    ...
    parser.add_argument("--checkpoint_dir", type=str, default="/data/c-justwu/a1/checkpoints/MoE/checkpoint.pt")
    parser.add_argument("--wandb_project", type=str, default="MoE")
